...
from vizualization import vizual
...
#'>eg,oijehuowyvgffyt8aiFYUIGWFU3E4
def menu():
    mainmenu = Menu(root)
    ...
    filemenu.add_command(label="Предоброботка данных")
    filemenu.add_command(label="Визуализация", command=vizual)
